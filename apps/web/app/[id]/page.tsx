...
export default function CryptoDetailPage({ params }: { params: { id: string } }) {
  const { data, isLoading, isError } = useCryptoById(params.id as string);
							...
							<div>
								...
								<CardDescription className='flex items-center'>
									...
									>
										...
										{formatPercentage(
											Math.abs(data?.price_change_percentage_24h)
										)}{" "}
										(24h)
									</span>
					...
					<Card>
						...
						<CardContent className='grid gap-4'>
							...
							<div>
								...
								<Progress
									value={(data?.circulating_supply / data?.max_supply) * 100}
									className='h-2'
								/>
								<div className='mt-1 flex justify-between text-xs text-muted-foreground'>
									...
									<span>Max: {data?.max_supply.toLocaleString()}</span>
								</div>
							</div>
							...
							<div className='grid gap-2'>
								<div className='flex items-center justify-between'>
									...
									<div className='text-right'>
										<p className='font-medium'>${data?.ath.toLocaleString()}</p>
								...
								<div className='flex items-center justify-between'>
									...
									<div className='text-right'>
										<p className='font-medium'>${data?.atl.toLocaleString()}</p>
										<p className='text-xs text-muted-foreground'>
								...
								<div className='flex items-center justify-between'>
									...
									<p
										className={`text-sm font-medium ${data?.ath_change_percentage >= 0 ? "text-green-500" : "text-red-500"}`}
									>
								...
								<div className='flex items-center justify-between'>
									...
									<p
										className={`text-sm font-medium ${data?.atl_change_percentage >= 0 ? "text-green-500" : "text-red-500"}`}
									>
						...
						<CardContent>
							<div className='space-y-3'>
								<div className='flex items-center justify-between'>
									...
									<p
										className={`font-medium ${data?.price_change_24h >= 0 ? "text-green-500" : "text-red-500"}`}
									>
										${Math.abs(data?.price_change_24h).toLocaleString()}
									</p>
								</div>
								<div className='flex items-center justify-between'>
									<p className='text-sm text-muted-foreground'>
									...
									<p
										className={`font-medium ${data?.price_change_percentage_24h >= 0 ? "text-green-500" : "text-red-500"}`}
									>
								...
								<div className='flex items-center justify-between'>
									...
									<p
										className={`font-medium ${data?.market_cap_change_24h >= 0 ? "text-green-500" : "text-red-500"}`}
									>
										{formatNumber(Math.abs(data?.market_cap_change_24h))}
									</p>
								</div>
								<div className='flex items-center justify-between'>
									<p className='text-sm text-muted-foreground'>
									...
									<p
										className={`font-medium ${data?.market_cap_change_percentage_24h >= 0 ? "text-green-500" : "text-red-500"}`}
									>
						...
						<CardContent>
							<div className='space-y-3'>
								...
								<div className='flex items-center justify-between'>
									...
									<p className='font-medium'>
										{formatNumber(data?.fully_diluted_valuation)}
									</p>
								</div>
							</div>
						</CardContent>
						...
						<CardContent>
							<div className='space-y-3'>
								...
								<div className='flex items-center justify-between'>
									...
									<p
										className={`font-medium ${data?.ath_change_percentage >= 0 ? "text-green-500" : "text-red-500"}`}
									>
										{formatPercentage(data?.ath_change_percentage)}
									</p>
								</div>
								<div className='flex items-center justify-between'>
									...
									<p
										className={`font-medium ${data?.atl_change_percentage >= 0 ? "text-green-500" : "text-red-500"}`}
									>
										{formatPercentage(data?.atl_change_percentage)}
									</p>
								</div>
